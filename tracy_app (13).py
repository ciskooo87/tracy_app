...
# Estilo modo escuro e balões tipo ChatGPT com input na parte inferior
st.markdown(
    '''
    <style>
    .main {
...
# Campo de entrada no final da tela
